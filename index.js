...
var mapO = __webpack_require__(/*! map-o */ "./node_modules/map-o/lib/index.js"), iterateObject = __webpack_require__(/*! iterate-object */ "./node_modules/iterate-object/lib/index.js");
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/^[a-z\d](?:[a-z\d]|-(?=[a-z\d])){0,38}$/i);
...
var Buffer = (__webpack_require__(/*! safer-buffer */ "./node_modules/safer-buffer/safer.js").Buffer);
var bomHandling = __webpack_require__(/*! ./bom-handling */ "./node_modules/iconv-lite/lib/bom-handling.js"), iconv = module.exports;
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(/*! ../encodings */ "./node_modules/iconv-lite/encodings/index.js");
...
var Buffer = (__webpack_require__(/*! buffer */ "buffer").Buffer), Transform = (__webpack_require__(/*! stream */ "stream").Transform);
module.exports = function (iconv) {
...
var gPO = (typeof Reflect === 'function' ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype
    ? function (O) {
        return O.__proto__;
    }
    : null);
...
const I18n = __webpack_require__(/*! ../common/I18n */ "./src/common/I18n.js");
const Card = __webpack_require__(/*! ../common/Card */ "./src/common/Card.js");
const icons = __webpack_require__(/*! ../common/icons */ "./src/common/icons.js");
const { getStyles } = __webpack_require__(/*! ../getStyles */ "./src/getStyles.js");
const { statCardLocales } = __webpack_require__(/*! ../translations */ "./src/translations.js");
const { kFormatter, flexLayout, clampValue, measureText, getCardColors, } = __webpack_require__(/*! ../common/utils */ "./src/common/utils.js");
const createTextNode = ({ icon, label, value, id, index, showIcons, shiftValuePos, }) => {
...
const renderStatsCard = (stats = {}, options = { hide: [] }) => {
    ...
    const { hide = [], show_icons = false, hide_title = false, hide_border = false, hide_rank = false, include_all_commits = false, line_height = 25, title_color, icon_color, text_color, bg_color, theme = "default", custom_title, border_radius, border_color, locale, disable_animations = false, } = options;
    ...
    const statItems = Object.keys(STATS)
        ...
        .map((key, index) => createTextNode({
        ...STATS[key],
        index,
        showIcons: show_icons,
        shiftValuePos: (!include_all_commits ? 50 : 35) + (isLongLocale ? 50 : 0),
    }));
    ...
    const width = hide_rank
        ? clampValue(50 + calculateTextWidth() * 2, 270, Infinity)
        : 495;
    const card = new Card({
    ...
    const labels = Object.keys(STATS)
        ...
        .map((key) => {
        if (key === "commits") {
            return `${i18n.t("statcard.commits")} ${include_all_commits ? "" : `in ${new Date().getFullYear()}`} : ${totalStars}`;
        }
...
const { getAnimations } = __webpack_require__(/*! ../getStyles */ "./src/getStyles.js");
const { flexLayout, encodeHTML } = __webpack_require__(/*! ../common/utils */ "./src/common/utils.js");
class Card {
...
const { logger, CustomError } = __webpack_require__(/*! ../common/utils */ "./src/common/utils.js");
...
const wrap = __webpack_require__(/*! word-wrap */ "./node_modules/word-wrap/index.js");
const themes = __webpack_require__(/*! ../../themes */ "./themes/index.js");
const toEmoji = __webpack_require__(/*! emoji-name-map */ "./node_modules/emoji-name-map/lib/index.js");
...
function getCardColors({ title_color, text_color, icon_color, bg_color, border_color, theme, fallbackTheme = "default", }) {
...
const githubUsernameRegex = __webpack_require__(/*! github-username-regex */ "./node_modules/github-username-regex/module.js");
const retryer = __webpack_require__(/*! ../common/retryer */ "./src/common/retryer.js");
const calculateRank = __webpack_require__(/*! ../calculateRank */ "./src/calculateRank.js");
const { request, logger, CustomError, MissingParamError, } = __webpack_require__(/*! ../common/utils */ "./src/common/utils.js");
...
const getStyles = ({ titleColor, textColor, iconColor, show_icons, progress, }) => {
    ...
    ${ false ? 0 : getProgressAnimation({ progress })}
  `;
};
...
const { encodeHTML } = __webpack_require__(/*! ./common/utils */ "./src/common/utils.js");
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_cards_stats_card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @src/cards/stats-card */ "./src/cards/stats-card.js");
/* harmony import */ var _src_cards_stats_card__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_cards_stats_card__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_common_blacklist__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @src/common/blacklist */ "./src/common/blacklist.js");
/* harmony import */ var _src_common_blacklist__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_src_common_blacklist__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _src_common_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @src/common/utils */ "./src/common/utils.js");
/* harmony import */ var _src_common_utils__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_src_common_utils__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _src_fetchers_stats_fetcher__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @src/fetchers/stats-fetcher */ "./src/fetchers/stats-fetcher.js");
/* harmony import */ var _src_fetchers_stats_fetcher__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_src_fetchers_stats_fetcher__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _src_translations__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @src/translations */ "./src/translations.js");
/* harmony import */ var _src_translations__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_src_translations__WEBPACK_IMPORTED_MODULE_4__);
...
app.get("/api", async (req, res) => {
    const { username, hide, hide_title, hide_border, hide_rank, show_icons, count_private, include_all_commits, line_height, title_color, icon_color, text_color, bg_color, theme, cache_seconds, custom_title, locale, disable_animations, border_radius, border_color, } = req.query;
    res.setHeader("Content-Type", "image/svg+xml");
    if (_src_common_blacklist__WEBPACK_IMPORTED_MODULE_1___default().includes(username)) {
        return res.send((0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.renderError)("Something went wrong"));
    }
    if (locale && !(0,_src_translations__WEBPACK_IMPORTED_MODULE_4__.isLocaleAvailable)(locale)) {
        return res.send((0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.renderError)("Something went wrong", "Language not found"));
    }
    try {
        const stats = await _src_fetchers_stats_fetcher__WEBPACK_IMPORTED_MODULE_3___default()(username, (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(count_private), (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(include_all_commits));
        const cacheSeconds = (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.clampValue)(parseInt(cache_seconds || _src_common_utils__WEBPACK_IMPORTED_MODULE_2__.CONSTANTS.FOUR_HOURS, 10), _src_common_utils__WEBPACK_IMPORTED_MODULE_2__.CONSTANTS.FOUR_HOURS, _src_common_utils__WEBPACK_IMPORTED_MODULE_2__.CONSTANTS.ONE_DAY);
        res.setHeader("Cache-Control", `public, max-age=${cacheSeconds}`);
        return res.send(_src_cards_stats_card__WEBPACK_IMPORTED_MODULE_0___default()(stats, {
            hide: (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseArray)(hide),
            show_icons: (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(show_icons),
            hide_title: (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(hide_title),
            hide_border: (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(hide_border),
            hide_rank: (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(hide_rank),
            include_all_commits: (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(include_all_commits),
            line_height,
            title_color,
            icon_color,
            text_color,
            ...
            disable_animations: (0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.parseBoolean)(disable_animations),
        }));
    }
    catch (err) {
        return res.send((0,_src_common_utils__WEBPACK_IMPORTED_MODULE_2__.renderError)(err.message, err.secondaryMessage));
    }
});
app.listen(port, () => {
